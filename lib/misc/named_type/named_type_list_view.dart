...
import 'package:easyt/misc/list/editable_list_view.dart';
import 'package:easyt/misc/named_type/named_type_tile.dart';
...
class NamedTypeListView extends StatelessWidget with ActionButtonMixin {
  NamedTypeListView({Key? key}) : super(key: key);
